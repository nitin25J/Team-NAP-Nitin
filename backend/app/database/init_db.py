    ...
    try:
        ...
        if db.query(HospitalModel).count() == 0:
            hospitals = [
                ...
                HospitalModel(
                    name="Dhemaji District Civil Hospital",
                    district="Dhemaji",
                    beds_available=9,
                    beds_total=75,
                    icu_available=1,
        ...
        if db.query(ShelterModel).count() == 0:
            shelters = [
                ...
                ShelterModel(
                    name="Jorhat Indoor Stadium Relief Camp",
                    district="Jorhat",
                    capacity=600,
                    occupancy=380,
                    lat=26.7520,
                ...
                ShelterModel(
                    name="Golaghat Town Hall Shelter",
                    district="Golaghat",
                    capacity=350,
                    occupancy=290,
                    lat=26.5180,
                ...
                ShelterModel(
                    name="Silchar District Relief Shelter",
                    district="Cachar",
                    capacity=800,
                    occupancy=650,
                    lat=24.8350,
                ...
                ShelterModel(
                    name="Guwahati Sector 3 Relief Center",
                    district="Kamrup Metropolitan",
                    capacity=500,
                    occupancy=210,
                    lat=26.1480,
                ...
                ShelterModel(
                    name="Dibrugarh High School Shelter",
                    district="Dibrugarh",
                    capacity=550,
                    occupancy=410,
                    lat=27.4750,
                ...
                ShelterModel(
                    name="North Lakhimpur Govt College Relief Camp",
                    district="Lakhimpur",
                    capacity=400,
                    occupancy=330,
                    lat=27.2360,
                ...
                ShelterModel(
                    name="Dhemaji Town Relief Center",
                    district="Dhemaji",
                    capacity=300,
                    occupancy=275,
                    lat=27.4820,
        ...
        if db.query(RescueTeamModel).count() == 0:
            teams = [
                ...
                RescueTeamModel(
                    team_id="SDRF-BRAVO",
                    name="SDRF Unit Bravo",
                    type="SDRF State Force",
                    district="Golaghat",
                    personnel_count=30,
                    status="Deployed",
                    lat=26.5170,
                ...
                RescueTeamModel(
                    team_id="ARMY-CHARLIE",
                    name="Indian Army Column 4",
                    type="Military Relief",
                    district="Cachar",
                    personnel_count=60,
                    status="Deployed",
                    lat=24.8340,
                ...
                RescueTeamModel(
                    team_id="BOAT-UNIT-01",
                    name="Sivasagar Motorboat Fleet",
                    type="Inflatable Boat Unit",
                    district="Sivasagar",
                    personnel_count=16,
                    status="Deployed",
                    lat=26.9810,
                ...
                RescueTeamModel(
                    team_id="QRT-DELTA",
                    name="Guwahati Quick Response",
                    type="Medical Evac QRT",
                    district="Kamrup Metropolitan",
                    personnel_count=20,
                    status="Standby",
                    lat=26.1450,
                ...
                RescueTeamModel(
                    team_id="FIRE-02",
                    name="Jorhat Fire & Rescue Unit",
                    type="Fire & Emergency Svc",
                    district="Jorhat",
                    personnel_count=18,
                    status="Standby",
                    lat=26.7530,
                ...
                RescueTeamModel(
                    team_id="HELO-AIR-1",
                    name="IAF Chopper Rescue Sqn 3",
                    type="Air Evacuation Squadron",
                    district="Lakhimpur",
                    personnel_count=12,
                    status="Deployed",
                    lat=27.2380,
...
if __name__ == "__main__":
    init_db()
    print(
        "Database initialized and seeded with rich Assam disaster intelligence dataset."
    )
