...
def get_map_data() -> Dict[str, Any]:
    ...
    for p in predictions:
        ...
        lat = 26.1445
        lng = 91.7362
        if district == "Sivasagar": lat, lng = 26.9826, 94.6425
        elif district == "Jorhat": lat, lng = 26.7509, 94.2037
        elif district == "Golaghat": lat, lng = 26.5167, 93.9667
        elif district == "Cachar": lat, lng = 24.8333, 92.7667
        elif district == "Charaideo": lat, lng = 26.9000, 94.8800
        elif district == "Dibrugarh": lat, lng = 27.4728, 94.9120
        elif district == "Nagaon": lat, lng = 26.3463, 92.6840
